window.onload=()=>{var ready=!1;setInterval(()=>{ready=($(".playControls__wrapper").length!=0);var playing=$(".playControl")[0].title=="Pause current",track=$("a.playbackSoundBadge__titleLink")[0].title+" By "+$("a.playbackSoundBadge__lightLink")[0].title,artwork=$(".playbackSoundBadge span.sc-artwork").css("background-image").replace("url(\"","").replace("\")","").replace("50x50.","500x500."),fav=$(".playControls__soundBadge .sc-button-like")[0].title=="Unlike",current=$(".playbackTimeline__timePassed span[aria-hidden]").text(),end=$(".playbackTimeline__duration span[aria-hidden]").text();if(ready&&json.track!=track){json.track=track;json.artwork=artwork;post()}
...
if(json.time.end!=end){json.time.end=end;post()}},500)}
...
default:{break}}});var json={"playing":!1,"track":null,"artwork":null,"favorite":!1,"shuffle":!1,"repeat":"none","time":{"current":null,"end":null}}